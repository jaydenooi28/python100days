...
while play_game:
    ...
    while game_on:
        ...
        player_score = calculate_score(p_card1,p_card2)
        ...
        dealer_score = calculate_score(d_card1,d_card2)
        ...
        while hand <= 5 and draw_card and not p_game_over and player_score < 21:
            ...
            if draw.lower() not in ["y", "n"]:
                ...
                player_score = calculate_score(player_score,p_new_card)
        ...
        while dealer_score < 16 and d_hand <=5 and not d_game_over and not p_game_over:
            ...
            dealer_score = calculate_score(dealer_score,d_new_card)
