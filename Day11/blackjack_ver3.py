...
def calculate_score(card1, card2,on_hand):
    ...
    # In the 1st round, the card1 input is a tuple, ('6', 'Clubs'), takes the 1st index as a value 
    # 2nd round onwards, card1 takes the score from 1st round(int) as an input
    ...
    # if both value are Ace
    if rank1 == "Ace" and rank2 == "Ace":
        return 21
...
while play_game:
    ...
    p_hand_str = ""
    game_on = True
    # Game round, end the loop if either players gets black jack
    game_round = True
    while game_round:
        print(logo)
        ...
        while hand <= 5 and draw_card and not p_game_over and player_score < 21 and game_round == True :
            print("===========================================================================================================================")
        ...
        while dealer_score < 16 and d_hand <=5 and not d_game_over and not p_game_over and game_round == True:
            if dealer_score > 21:
        ...
        elif dealer_score == 21 and d_hand == 2 and player_score == 21 and hand == 2:
            print("Both the dealer and player have Blackjack.\nDealer Wins")
        elif dealer_score == 21 and d_hand == 2:
            print("Dealer wins with Blackjack.")
        elif player_score == 21 and hand == 2:
